...
class Window(Frame):
    ...
    def init_window(self):
        ...
        num3 = 0
        self.num3 = num3
        message = lambda : messagebox.showinfo(title="About", message="A GUI Calculator i wrote using Github and Stackoverflow")
        message2 = lambda : messagebox.showinfo(title="Help", message="Why do you want help for a SIMPLE working calculator!!")
        menubar = Menu(self)
        menubar.add_command(label="About", command=message) # About - menu
        menubar.add_command(label="Help", command=message2) #Help - menu
